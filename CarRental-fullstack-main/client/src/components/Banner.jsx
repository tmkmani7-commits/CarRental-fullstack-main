...
const Banner = () => {
  return (
    ...
    className='flex flex-col md:flex-row md:items-start items-center justify-between px-8 min-md:pl-14 pt-10 bg-gradient-to-r from-black via-[#1f1f1f] to-[#DC2626] max-w-6xl mx-3 md:mx-auto rounded-2xl overflow-hidden'>
