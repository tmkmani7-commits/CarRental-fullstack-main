...
export const ownerMenuLinks = [
    { name: "Dashboard", path: "/owner", icon: dashboardIcon, coloredIcon: dashboardIconColored, end: true },
    ...
    { name: "Users", path: "/owner/users", icon: users_icon, coloredIcon: users_icon },
    { name: "Settings", path: "/owner/settings", icon: filter_icon, coloredIcon: filter_icon },
    { name: "Logout", action: "logout", icon: close_icon },
]
